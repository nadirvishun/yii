...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'creat_time'); ?>
		<?php echo $form->textField($model,'creat_time'); ?>
		<?php echo $form->error($model,'creat_time'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'creat_user_id'); ?>
		<?php echo $form->textField($model,'creat_user_id',array('size'=>10,'maxlength'=>10)); ?>
		<?php echo $form->error($model,'creat_user_id'); ?>
	</div>
