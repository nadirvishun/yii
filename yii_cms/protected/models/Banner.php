...
class Banner extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('banner_img, banner_title, creat_time, update_time, status_id', 'required'),
			...
			array('id, banner_url, banner_img, banner_title, creat_time, update_time, creat_user_id, update_user_id, status_id', 'safe', 'on'=>'search'),
		);
	}
