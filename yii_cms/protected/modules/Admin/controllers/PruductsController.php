...
class PruductsController extends Controller
{
	/**
...
// 			),
	...
	{
		$dataProvider=new CActiveDataProvider('Pruducts');
	...
	{
		$model=new Pruducts('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Pruducts']))
			$model->attributes=$_GET['Pruducts'];
	 ...
	 * @return Pruducts the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Pruducts::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Pruducts $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='pruducts-form')
		{
